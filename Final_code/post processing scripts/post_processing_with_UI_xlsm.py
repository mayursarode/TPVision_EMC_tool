...
import webbrowser
import os
#os.chdir("C:\Python27\Lib\xlwt-0.7.5")
#ex.os.chdir("C:\Python27\Lib\xlwt-0.7.5")
import subprocess
import xlwt
...
class Post_processing(Tkinter.Tk):
    ...
    # Attenuation Block
        ...
        self.entry_pwd.insert(0, "Enter file name")  
        ...
        self.entry_pwdxl.insert(0, "Enter Excel file name")  
...
def cdf_calculation_wifi(a_pwdxl,a_pwd, a_st, a_stt,a_att,a_tab, a_bw,a_iprf):
        ...
        ws = wbk.get_active_sheet()
        a_tab=ws
        #sheet.write(11,1,"10 % cdf")
        #sheet.write(13,3,"90 % cdf")
        #sheet.write(15,5,"50 % cdf")
...
######################## Extracting the Data rate##############################################
            ...
            sheet.write(ex_c,11,conf_10)
            sheet.write(ex_c,13,conf_90)
            sheet.write(ex_c,15,conf_50)
...
if __name__ == "__main__":
    ...
    #path= '/home/wireless/Documents/Wireless_measurement_tool_TPVision/TPvision-logo.tiff' Path for TP Vision logo in Linux
    path=os.path.abspath("TPVision-logo.tiff")
    #path= '\Users\mayur.sarode\Documents\EMC_testing\new_EMC_tool\Wireless_measurement_tool_TPVision\TPvision-logo.tiff'  #Path for TP Vision logo in Windows
